...
当前版本：**v1.3.1** · Node 后端 + Vue 3 Web + Android 客户端 · Android scrcpy 4.0 WebSocket + 鸿蒙 HDC JPEG + iOS WDA MJPEG 投屏
...
| **多应用投屏** | 投屏模式下拉选「多应用投屏」：左侧栏隐藏、右侧全宽 Windows 桌面；Win11 风格任务栏（开始、WiFi+音量快速设置、时间/日期与农历日历）；通知中心打开时每秒同步设备通知（图标/标题/内容） |
