...
当前版本：**v0.12.22** · Node 后端 + Vue 3 Web + Android 客户端 · 基于 [scrcpy](https://github.com/Genymobile/scrcpy) 4.0 自编译 WebSocket 投屏
...
- 已选设备以网格实时投屏（720p / 20fps / 2Mbps，多路错开启动），画布可触控
