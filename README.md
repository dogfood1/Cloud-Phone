...
当前版本：**v0.12.38** · Node 后端 + Vue 3 Web + Android 客户端 · Android scrcpy 4.0 WebSocket + 鸿蒙 HDC JPEG 投屏
...
| **Docker/CI** | 新增 `docker-compose.yml` + GitHub Actions：提交信息含 `docker` 自动构建并推送 Docker Hub 镜像 |
